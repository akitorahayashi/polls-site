...
def test_homepage_loads(e2e_services):
    ...
    try:
        ...
        # A fresh Django project usually has a welcome page. Let's check for "The install worked successfully!".
        # Or for the polls app, it might have "Polls"
        assert (
            "Polls" in response.text
            or "The install worked successfully!" in response.text
        )
